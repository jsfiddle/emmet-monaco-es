var emmetMonaco = (function (exports) {
  ...
  function isValidLocationMonarch(model, position, syntax, language) {
      ...
      if (typeof ((_a = anyModel.tokenization) === null || _a === void 0 ? void 0 : _a.tokenizeIfCheap) === 'function') {
      ...
      const state = (_d = (_c = (_b = _stateStore.getBeginState) === null || _b === void 0 ? void 0 : _b.call(_stateStore, lineNumber - 1)) === null || _c === void 0 ? void 0 : _c.clone()) !== null && _d !== void 0 ? _d : (_f = (_e = _stateStore.getStartState) === null || _e === void 0 ? void 0 : _e.call(_stateStore, lineNumber)) === null || _f === void 0 ? void 0 : _f.clone();
      if (!state)
          return false;
